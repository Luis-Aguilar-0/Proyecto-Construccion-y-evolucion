...
public class PathsImages {
    ...
    public static final String PERFIL = "/imagenes/imagesPerfil/perfil4.png";
    public static final String CARRITO = "/imagenes/imagesPerfil/carrito.png";
    public static final String BUSQUEDA = "/imagenes/imagesPerfil/busqueda.png";
    public static final String FONDO = "/imagenes/imagesPerfil/Fondo.jpg";
