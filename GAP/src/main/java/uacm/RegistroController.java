...
public class RegistroController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        registrar_bttn.setOnAction(event -> {
            int dia = Integer.parseInt(dia_box.getValue());//se cambio a tipo int
            int mes = Integer.parseInt(mes_box.getValue());//se cambio a tipo int
            int anio = Integer.parseInt(anio_box.getValue());//se cambio a tipo int
            ...
            Date fecha = java.sql.Date.valueOf(LocalDate.of(anio, mes, dia)); //dando formato a la fecha
     ...
     * double anchoPref = Math.min(nuevoAncho * 0.7, 600); // 70% del ancho pero
     * máximo 600px
